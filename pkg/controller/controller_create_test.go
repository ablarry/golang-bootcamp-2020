...
func TestCreate(t *testing.T) {
	...
	table := []struct {
		...
		*http.Request
		...
		{
			"1._ OK: Create",
			newRequest(http.MethodPost, PokemonsEndpoint, `{ "id": 1,"category": "Seed",  "name": "Bulbasaur", "type": "Grass", "wakness": "Fire" }`),
			http.StatusCreated,
		...
		},
		{
			...
			newRequest(http.MethodPost, PokemonsEndpoint, ` "id": 1, "wakness": "Fire" `),
